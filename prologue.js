...
const PROLOGUE_PATCHES = {
  ...
  // ── THE CURATOR ─────────────────────────────────────────────────
  // Unmasked. Host. Misdirect: the warm loyalty crack on Ashworth.
  'curator': {
    room: 'foyer',
    intro: 'He is in the Foyer when you cross the threshold, unmasked, hands folded behind his back in the precise attitude of a man who has been standing exactly so for some time and intends to stand exactly so until eight. The grandfather clock by the staircase has just declared seven, and is taking its time about being believed.\n\nHe inclines his head a fraction — the fraction owed to a guest of the house.\n\n"Mr. Grey." A small, dry pause. "Welcome. The Estate has been expecting you. The Rite begins at eight."',
    dialogue: {
      'Q1': { question: 'You were expecting me.',          type: 'choice', response: '"The Estate was. The Estate is generally expecting someone — it is one of the few institutions in the country that has not had to revise the assumption." A small gesture at the room. "Tonight it happens to be you. Lord Ashworth thought it appropriate that a first-time visitor be received by someone whose duties this evening are largely ceremonial. I am the ceremonial part. The Rite is the rest."' },
      'Q2': { question: 'What is the Rite, exactly?',      type: 'choice', response: '"A ceremony." A pause that is, for him, almost a smile. "That is not a useful answer. Let me try again. Lord Ashworth will open the Black Register before the assembled membership at eight o\'clock. The Register has not been opened in public in living memory." A breath. "Most of the people in this house tonight have been preparing for that fact in one form or another. A few of them have been preparing in ways the Register itself will eventually describe."' },
      'Q3': { question: 'What kind of man is Lord Ashworth?', type: 'choice', response: '"Meticulous." The word lands flat, the way a bricklayer sets a brick. Then his voice does an unexpected thing — softens, briefly, around what comes next. "He has run this Estate for forty years. He has, in that time, declined to misplace a record, a name, a debt, or a man who deserved better." The softness goes back to wherever he keeps it. "He has been preparing for tonight for six years. When a man spends six years preparing to say a thing in public, what he intends to say is generally either very true or very dangerous. With Ashworth it tends to be both. That is the work of the evening."' },
      'Q4': { question: 'Why am I the only one without a mask?', type: 'choice', response: '"Because you are not yet a member. The mask is a courtesy the Estate extends to those it has reason to conceal. Tonight the Estate has reason to conceal nearly everyone." The almost-smile returns. "You may take some comfort in being the exception. Most people, in my experience, do not. Most people would rather be hidden than seen, and tonight is the kind of evening that proves them right."' },
      'Q5': { question: 'Where should I go until eight?',  type: 'choice', response: '"Anywhere that is not the Ballroom. The Ballroom is closed until the assembly convenes, and I am, between us, glad of it." A small dry note. "That room has the worst acoustic in the building, and has been spared the worst conversations of the evening only because no one has yet been allowed inside it." A measured nod. "The grounds are open. The guests are masked. They will not, as a rule, introduce themselves. Try not to read this as rudeness. Read it as architecture."' },
    },
  },

  // ── NORTHCOTT (masked) ──────────────────────────────────────────
  // Misdirect: a single sentence of cold, professional precision about the notebook.
  'northcott': {
    room: 'weapons-room',
    intro: 'A young masked figure stands among the mounted sabres in the upright posture of a man who has been told to be somewhere and has decided to be there exactly. A leather-bound notebook is tucked under one arm. There is a small sherry on the side-table beside him, untouched, and the way it is being not-touched suggests he is putting genuine effort into it.\n\nHe looks up sharply when you enter — caught between a polite nod, an outright salute, and possibly a curtsey, and committing fully to none of the three. A clock somewhere in the corridor behind you ticks audibly. He glances at it.',
    dialogue: {
      ...
      'Q2': { question: 'You don\'t look like you\'re enjoying yourself.', type: 'choice', response: '"I am." Said immediately, which is the wrong way to answer the question. He hears himself. "That is — I am attempting to. The sherry is excellent. The rooms are warm. The masks — the masks are uniformly intimidating in a way I had not anticipated." A glance at the door. "My mother said it would be like a wedding. It is not like a wedding."' },
      'Q3': { question: 'What\'s the notebook for?',       type: 'choice', response: 'For a moment something quite different surfaces. The sentence that comes out is professional, unembarrassed, and arrives in the cadence of a man who has done this kind of work before: "Times of arrival, exact to the minute. Cross-reference against the seating manifest. Anomalies flagged in the margin in pencil so the entry can be revised without crossing-out." A short pause. He hears himself again. The shoulders go up by a fraction. "That is what I have been told to do. I am told it is — standard."' },
      'Q4': { question: 'Who told you you had the right temperament?', type: 'choice', response: '"Lord Ashworth." With the small helpless pride of a man not certain whether he was praised or recruited. "Six weeks ago. He did not specify which temperament. He is not, by reputation, the sort of man one asks twice. I have been examining various of my temperaments since, looking for the responsible one. So far, no luck."' },
    },
  },

  // ── THE STEWARD (masked) [form-break] ───────────────────────────
  // FORM-BREAK: not at candelabra. At head of table. Looking at one place card.
  // Player speaks first. The intro does not mention seeing the player.
  'steward': {
    room: 'dining-room',
    intro: 'The dining room has been set for sixty — glassware, place cards, the slight catastrophe of perfectly arranged flowers — and the room smells faintly of beeswax and cold roses. The candles are not yet lit; that comes at quarter to.\n\nA masked figure stands at the head of the table. Not at the candelabra, where one would expect to find him. At the head, where one would not. He is looking down at a single place card. His hands are clasped behind his back, precisely. He has been standing exactly so for some time.\n\nHe does not turn when you enter. He is aware of you. He is choosing not to be.',
    dialogue: {
      'Q1': { question: 'Good evening.',                   type: 'choice', response: 'Only then does he turn, and only by degrees. "Good evening, sir." The hands stay behind the back. The place card is not commented on. "The candles will be lit at quarter to. Until then the room is — resting. I find rooms appreciate the courtesy."' },
      'Q2': { question: 'You weren\'t at the candelabra.', type: 'choice', response: 'A pause that is not exactly a pause — more an adjustment of the air around him. "No, sir. I was attending to the seating. The placements were finalised three weeks ago, but one — confirms." His eyes do not return to the card. They have been instructed not to. "It is the kind of thing one does when one has done it for a great many years. The work has stopped requiring the head and continued requiring the hands."' },
      'Q3': { question: 'You\'ve been here a long time.',  type: 'choice', response: '"Long enough, sir. The house has not required me to count." A pause — and then, the small permission of an evening before any harm has been done, something almost confiding: "I have outlasted three sovereigns of the Society and four chefs. The chefs were the harder loss."' },
      'Q4': { question: 'What are you watching for?',      type: 'choice', response: 'The almost-confiding has gone. The hands stay behind the back, precisely. "The candles, sir. They burn unevenly in this room because of a draught from the south window, which has been there since 1881 and which the Estate has, in three separate budgets, declined to address." A second pause, shorter. "It is the thing one watches for. Among others."' },
      'Q5': { question: 'See you at the Rite.',            type: 'choice', response: '"At the Rite, sir. Good evening." He does not return to the place card. He waits. The waiting will continue, in some form, until eight.' },
    },
  },

  // ── THE BARON (masked) ──────────────────────────────────────────
  // Misdirect (Q3): one sharp half-sentence of a different man before he covers.
  'baron': {
    room: 'study',
    intro: 'A masked figure occupies one of the leather armchairs by the fire with the proprietary air of a man who has decided this chair will be his and would not be sorry if anyone tried to contest the claim. Cigar smoke trails toward the ceiling in a thin unhurried line. There is a glass on the side-table; the glass has not been full for some time. The mask is heavy — feathered, expensive, the sort that announces itself by trying not to.\n\nThe study clock reads seven minutes past. He has not consulted it. He does not need to.',
    dialogue: {
      ...
      'Q3': { question: 'What should I know about Lord Ashworth?', type: 'choice', response: '"Ashworth." The cigar pauses. So does, briefly, the man holding it. The next half-sentence comes out in a register the rest of the conversation has not used: low, exact, unornamented. "There are perhaps four men alive who have any idea what he is about to do tonight. He is one. I am another." Then he is back, the cigar resuming its line. "He is meticulous. He has been preparing for this for six years. When a man spends six years preparing to say a thing in public, what he means to say is generally either very true or very dangerous. Ashworth tends to manage both. It is one of his less endearing qualities, and the reason I have always found him bearable."' },
      'Q4': { question: 'Why are you in here, not out there?', type: 'choice', response: '"Two reasons." He raises the cigar. "This. And —" he raises the glass. "This. The Estate prefers its members to mingle before a Rite. I have always taken the view that mingling is best done by sitting absolutely still and waiting for the more interesting half of the room to come and find me." The glass tips a fraction toward you, in something not quite a toast. "Tonight — the system has worked."' },
    },
  },

  // ── LADY ASHWORTH (masked) ──────────────────────────────────────
  // Misdirect already inline (Q3 "other things"). Sharpen, don't add.
  'ashworth': {
    room: 'conservatory',
    intro: 'A masked woman stands among the glass and the trailing greenery of the conservatory, a folded letter held loosely between gloved fingers. The lamps are kept low here — they have always been kept low here — and the orchids have the slightly louche posture of plants that have been listening to too many conversations.\n\nA single candle on the wrought-iron table beside her has burned an inch lower than the others in the room. She is briefly in a good mood, which is not a thing one would say of her at any other point in the evening that follows.',
    dialogue: {
      ...
      'Q3': { question: 'You don\'t seem nervous about tonight.', type: 'choice', response: '"Should I be?" Not defensive. Curious — the slightly amused curiosity of a woman asked a thing she has not, herself, thought to ask. "My husband has prepared for tonight for six years. In that time he has learned the names of every member, the seal-press of every house, and the precise weight of three centuries of Society silver. Tonight will go exactly as he has arranged." The amused note is gone, briefly, before she replaces it. "It would not occur to me to be nervous about a thing my husband has prepared. It would occur to me to be nervous about other things. But not that."' },
      'Q4': { question: 'I\'ll let you wait.',             type: 'choice', response: '"Thank you." The letter is unfolded and refolded along the same crease. "I am not unhappy to have been disturbed. The orchids have run out of new things to say and I had been preparing to invent some on their behalf. You have spared us all a difficult half-hour."' },
    },
  },

  // ── CRANE (masked) ──────────────────────────────────────────────
  // Misdirect (Q4): one unguarded line. The sherry shows. The cleverness drops.
  'crane': {
    room: 'gallery',
    intro: 'A masked woman stands close to one of the portraits in the long Gallery — closer than the convention of the room suggests. The lamp on the wall picks up the small glint of a glass in her left hand. The glass has, in the recent past, contained sherry. It contains slightly less of it now.\n\nThe Gallery is the longest room in the house, and the quietest. From the far end, distantly, the murmur of the Foyer can be heard. It has been a little louder, in the last few minutes, than it was when she came in.',
    dialogue: {
      'Q1': { question: 'A friend of yours?',              type: 'choice', response: '"Mercifully, no. He died in 1804, of a hubris one can still see from across the room." A fractional tilt. "The brushwork is excellent. The face is appalling. There is a great deal to be said for the painters of two centuries ago — they had the courage to render their subjects accurately. We have lost the trick. Modern portraiture is so flattering one can no longer tell the bankers from the bishops."' },
      ...
      'Q4': { question: 'You don\'t look like a woman doing her best.', type: 'choice', response: 'A beat where the wit is supposed to arrive, and does not. She looks at the glass. The look is not for effect. "No." Said quietly. "I am better at it on other evenings." A small shake of the head, dismissing whatever almost happened. The professional composure comes back in like a tide. "The sherry is excellent. The admiral is dead. I have what I need."' },
  ...
  // ── VIVIENNE (masked) ───────────────────────────────────────────
  // Misdirect (Q3): one cold line. The flirt briefly observing the player like a specimen.
  ...
  'vivienne': {
    ...
    dialogue: {
      ...
      'Q3': { question: 'You know the Estate well?',       type: 'choice', response: 'For a moment the warmth is set down somewhere out of sight, like a glass on a railing. The look that replaces it is calm, and patient, and very thorough. "I know what the Estate tells me. The Estate is generous, if one is patient." Then the warmth is picked back up, lightly, as though it had never been put down at all. "Houses are not unlike men in this regard. The ones worth knowing reveal themselves slowly, and never to anyone in a hurry."' },
  ...
  // ── HATCH (masked) ──────────────────────────────────────────────
  // Misdirect (Q3): one line of unexpected precision. Then back to the three-word man.
  'hatch': {
    room: 'terrace',
    intro: 'A masked man stands at the far end of the terrace, near the low wall that drops to the rose beds. He is unhurried in the absolute way of a man who has worked outdoors for thirty years and has acquired, in that time, the patience of weather.\n\nA pewter mug rests on the stone beside him. It has been half-full the entire time you have been on the terrace, which suggests either he is sipping very slowly or the Estate\'s ale is not what it was.',
    dialogue: {
  ...
  // ── GREAVES (masked) ────────────────────────────────────────────
  // Misdirect (Q3): the cynic's real pleasure at being addressed. Sharpen.
  'greaves': {
    room: 'gallery',
    intro: 'A masked figure stands before a portrait of Lord Ashworth at the far end of the long Gallery, head tilted at the small judicial angle of a man comparing the painted version against the original and finding both, on balance, instructive.\n\nThe corridor beyond him has gone quieter in the last little while. He has noticed. He has not commented.',
    dialogue: {
      ...
      'Q2': { question: 'You know him well?',              type: 'choice', response: '"Long enough to recognise the work, sufficient to attend the Rite, insufficient to be surprised by anything that happens in it." A small observational pause. "Ashworth has been preparing for tonight for six years. I have learned, in the course of an unremarkable life, to take six-year preparations seriously. Three years one might dismiss as stubbornness. Four is excessive. Six is a position." The faintest amusement. "And Ashworth has never, in my acquaintance, taken a position he did not intend to defend."' },
      'Q3': { question: 'You don\'t sound entertained.',   type: 'choice', response: '"On the contrary." The cynicism does, very briefly, an unexpected thing — it gives way, for a single sentence, to something that sounds like gratitude. "You are early. I have been admiring this portrait for some time and you are the first person to address me in that time." The cynicism takes its hat back from the rack. "Either I am better-disguised than I had hoped, or the company is worse. I will not press for which."' },
  ...
  // Misdirect (Q4): one sentence where the vanity reveals what it is covering. Then back.
  'pemberton-hale': {
    room: 'trophy-room',
    intro: 'A tall masked figure stands among the cases and mounted heads of the Trophy Room with the proprietorial air of a man who is not the proprietor but feels he could have been. The gloved hands are clasped behind his back. The posture has been worked on. The shoes have been worked on. The mask itself, on closer look, is more carefully made than any other mask in the building tonight.\n\nFrom the corridor, very faintly, footsteps. He has been listening for them for some time.',
    dialogue: {
