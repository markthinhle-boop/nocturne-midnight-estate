...
const PROLOGUE_PATCHES = {
  ...
  // ── VIVIENNE (masked) ───────────────────────────────────────────
  // Flirting, and means it. The unmasked man is the only thing in the building she finds interesting.
  'vivienne': {
    room: 'terrace',
    intro: 'A masked woman is at the terrace balustrade, half-turned away from the warm light of the windows, looking out at the dark of the gardens. The angle of her shoulders is casual. The attention is not. She does not turn when you arrive. She has heard you. She is choosing the moment, and she is taking her time about it because she has decided the moment is worth choosing.',
    dialogue: {
      'Q1': { question: 'Good evening.',                   type: 'choice', response: '"Bonsoir." She turns then, and the smile is in the voice in a way the mask cannot quite contain. "You are the one without a mask. The Estate is doing it on purpose — the Estate does most things on purpose — but I have been on this terrace for twenty minutes and you are the most interesting thing that has happened to it. I thought you should know."' },
      'Q2': { question: 'You know the Estate well?',       type: 'choice', response: '"I know what the Estate tells me. The Estate is generous with what it tells, if one is patient and asks the right rooms." A small pause. "This house is a great deal more talkative than its owner. So are most of the people in it. Lord Ashworth is the only person under this roof who has ever made me work for an answer. I respect him for it. I do not always forgive him for it."' },
      'Q3': { question: 'Why are you out here alone?',     type: 'choice', response: '"I am not alone. You are here." Said without coyness — a fact, observed. "Before that — the Foyer was full of men explaining the Rite to each other in voices designed to be overheard. The drawing room was full of women pretending not to listen. The terrace was empty. I have a rule about empty terraces on warm evenings. I keep them company. They are grateful."' },
      'Q4': { question: 'I should let you enjoy it.',      type: 'choice', response: '"Should you." Not quite a question. She turns back to the gardens, but slowly, allowing it. "Eight o\'clock the Rite. After eight o\'clock — well. Houses tell more after eight o\'clock. They cannot help themselves. Find me again, Mr. Grey. There is more terrace where this came from."' },
    },
  },
