...
const ROOM_DESCRIPTIONS = {
  ...
  "train-rear":        "",
  // ── ESTATE ──────────────────────────────────────────────────
  "foyer":         "The gate attendant said nothing when he let you through. That was the first thing.\n\nThe Foyer is larger than it needs to be and quieter than it should be. A Society gathering on the night of the Rite should have sound. There is no sound.\n\nThe flowers are white. They belong in the study. Someone moved them tonight — after the arrangements were made and before whatever happened happened.\n\nThe painting at the top of the stairs has a frame built for a portrait. The subject has been replaced with something that refuses to be looked at directly.\n\nOne of the doors at the end has a handle that has been used recently. You can tell by the light on the metal.\n\nYou have the distinct impression the room was arranged for you specifically. Which either means you are very welcome. Or that someone very much wants you to feel that way. Tonight those two things may not be different.",

  "gallery":       "The Portrait Gallery contains five men who wanted to be remembered and one woman who wasn't asked. The frames are heavy. The light is not quite enough.\n\nBoth sets of candles are fresh. Both sets. Someone changed them twice tonight. The second change happened after the Rite began.\n\nThe guest book records every arrival. The Steward's handwriting. Everyone accounted for except one entry that was removed after it was made. The absence is more visible than the presence would have been.\n\nSomething in your jacket pocket that wasn't there when you walked through the gate. You didn't put it there. Someone did.",

  "study":         "Lord Ashworth's private study has been cleaned with remarkable thoroughness for a room that its owner will not be returning to. The desk is bare. The fireplace is warm.\n\nThe second chair faces the door. You notice this before you notice why you notice it.\n\nSomeone burned something here within the last two hours and would very much prefer you didn't think about what.",
...
(function _initGyroParallax() {
  ...
  function _getConfig() {
    ...
    cfg.x = Math.floor(appW * 0.75); // tuned: full image sweep without hitting black edge
    return cfg;
  }
