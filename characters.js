...
const CHARACTERS = {
  ...
  "northcott": {
    ...
    line_techniques: {
      Q1: {
        ...
        wait:     { callum_question: "Say nothing.", response: "He looks at the notebook. Not opening it — he knows what's in it.\n\n\"Seven o'clock. Post established. Members present.\" A pause. \"I kept the record continuously until seven-fifteen.\" He looks at the corridor. \"There is a gap. Seven-fifteen to seven-twenty-three. Eight minutes. I marked it differently from the rest.\" Another pause. \"I returned at seven-twenty-three and kept the record until eight-oh-one.\" He looks at you. \"That is what I do here.\"", callum: "He volunteered the gap before I asked for it. Eight minutes marked differently. He has been rehearsing this part of the conversation since eight o'clock.", composure: 0, grants: "northcott_false_gap" },
        account:  { callum_question: "\"Take me through the log. Start at seven.\"", response: "He opens the notebook.\n\n\"Seven o'clock, post established. Members present.\" He reads precisely. \"Continuous log until seven-fifteen.\" A pause. \"Seven-fifteen — I left my post. Eight minutes. I marked the gap. I returned at seven-twenty-three and logged continuously until eight-oh-one.\" He closes the notebook to the same page. \"The entries before and after the gap are direct observation. The gap entries are marked as reconstructed.\"", callum: "He has a word for it. Reconstructed. That word was chosen carefully. A man who marks his own gaps and labels them precisely has been thinking about how this record looks to someone else.", composure: 0, grants: "northcott_false_gap" },
        approach: { callum_question: "\"You've been at this post all evening.\"", response: "He looks at you steadily. \"With one gap.\" He says it before you finish. \"Seven-fifteen to seven-twenty-three.\" He opens the notebook. \"I left my post. Lord Ashworth had spoken to me before the Rite. What he said required me to find someone.\" He looks at the notebook. \"I found her. I came back at seven-twenty-three.\" He closes it. \"The record is accurate from that point.\"", callum: "He said her. He didn't say the name. Whatever Ashworth told him was about a person and he went to find that person in the eight minutes he left his post.", composure: 0, grants: "northcott_false_gap" },
        pressure: { callum_question: "\"Where were you during the murder window.\"", response: "He goes still. \"I was at my post.\" A pause. The formality climbs. \"The record documents my presence throughout the evening.\" He looks at the corridor. \"There is a gap. It is marked. The entries around it are accurate.\" He looks at you directly. \"I don't think I should say more about the gap without understanding why you're asking.\"", callum: "He closed. First question. He's been standing here for an hour ready to give this record to someone and the moment I pressed he shut down. Whatever the gap contains he's decided isn't mine yet.", composure: -15 },
      },
      Q2: {
        text: "What did you log tonight that you're still thinking about.",
        wait:     { callum_question: "Say nothing.", response: "This time he opens the notebook without being asked.\n\n\"The candelabra base.\" He says it simply. \"At seven-forty it was in its correct position at the lectern. At eight-oh-two when the Ballroom was entered — gone.\" He closes the notebook. \"I logged it at seven-forty because I log everything. I looked for it at eight-oh-two because Lord Ashworth told me — if anything unusual happens tonight, check the things you have already logged.\" A pause. \"The candelabra base was the first thing I had logged that could be used to hurt someone.\" He says it precisely. \"I used the word weapon to myself at eight-oh-two. I had not used it before that.\"", callum: "Ashworth told him to check what he'd logged if something unusual happened. He prepared him for this. The candelabra base is the first thing Northcott thought of because it's the first thing in his log that fits the shape of what happened tonight.", composure: -5 },
        account:  { callum_question: "\"What in the record is still open.\"", response: "He opens the notebook and reads.\n\n\"Seven-forty. Candelabra base. Correct position. Lectern.\" He reads it exactly as written. \"Eight-oh-two. Candelabra base. Absent.\" He closes it. \"Those are the two entries I keep returning to.\" A pause. \"Between those times something happened to that base. I was not looking at it during that interval.\" He holds the notebook. \"I was thinking about something else during that interval.\" Another pause. \"That is the accurate record of my attention tonight.\"", callum: "He said he was thinking about something else during the interval. He said it like a confession and moved past it. The candelabra gap and the eight-minute gap share the same interval. He knows that.", composure: -5 },
        approach: { callum_question: "\"The candelabra. You noticed something.\"", response: "\"The candelabra.\" He says it without surprise. \"Seven-forty in position. Eight-oh-two gone.\" He looks at the notebook. \"Lord Ashworth told me before the Rite — if anything unusual happens, check what you have already logged. The candelabra base was the first thing I had logged that could function as a weapon.\" A pause. \"I used that word to myself at eight-oh-two.\" He looks at you. \"I think you already know about the base. I think that is why you are here.\"", callum: "He thinks I already know. He is not managing what he tells me — he is meeting me where he thinks I am. A man who does that either has nothing to hide or has already decided what he is going to give.", composure: -10 },
        pressure: { callum_question: "\"You logged the candelabra position. Then it disappeared. Explain that.\"", response: "He stiffens slightly. \"I logged arrivals. That is my role here.\" A pause. \"The candelabra is a Ballroom inventory item. My record covers the foyer.\" He looks at the corridor. \"I don't see what the candelabra has to do with my role tonight.\"", callum: "He retreated into his role. Second question and he's narrowing his remit. He knows exactly what the candelabra has to do with tonight. That is why he is suddenly unclear about his jurisdiction.", composure: -18 },
      },
      Q3: {
        text: "What did Lord Ashworth say to you before the Rite.",
        wait:     { callum_question: "Say nothing.", response: "A long pause. The longest of the evening.\n\n\"He found me at seven-oh-five. In the east corridor.\" He does not look at the corridor this time. \"He said he knew about my arrangement with Vivienne.\" A pause. \"He said the Estate has explicit provisions against members being intimate with staff. He said my membership was in breach of those provisions.\" Another pause — slower. \"He said he was going to read it into the Register tonight. At the Rite. In front of everyone.\" He holds the notebook very still. \"He said nothing would stop that from happening.\" A pause. \"He said it without anger. That was the part I couldn't stop thinking about. No anger. Just the statement and its consequences.\"\n\nHe stops. He has finally set it down.", callum: "He's been carrying that since seven-oh-five. Four hours. He kept the record, logged the arrivals, marked the gap, noted the candelabra — all of it with that conversation sitting in his chest. No anger. Just the statement and its consequences. That is what Ashworth said. That is also what Northcott has been doing all evening.", composure: 0, grants: "northcott_vivienne_motive" },
        account:  { callum_question: "\"Walk me through the conversation.\"", response: "He opens the notebook. He does not read from it. He just holds it.\n\n\"Seven-oh-five. East corridor.\" He says it like a log entry. \"Lord Ashworth told me he was aware of my arrangement with Vivienne. He named the Estate provision it violated.\" A pause. \"He said it would be read into the Register tonight. My name. Her name. The violation.\" He looks at the notebook. \"He said it was not personal. He said the Estate has provisions and provisions exist to be observed.\" Another pause. \"He said nothing would stop the reading.\" He closes the notebook. \"That is what he said.\"", callum: "He reported it like a log entry. Name, time, violation, consequence. The same precision he applies to everything. The precision is how he survives things. He logged Ashworth's threat the same way he logged the candelabra.", composure: -10, grants: "northcott_vivienne_motive" },
        approach: { callum_question: "\"He threatened you tonight.\"", response: "\"You already know something.\" He says it. Not a question. \"He told me about Vivienne.\" A pause. \"The Estate has a provision. Members and staff — it's explicit. Lord Ashworth said I was in breach.\" He looks at the notebook. \"He said it would be in the Register tonight. Her name. My name.\" Another pause. \"He said nothing would stop it.\" He is very still. \"I spent the time between that conversation and eight-oh-one deciding what to do about it.\" He looks at you. \"I did not decide to kill him. I decided to find her and tell her before it happened so she would not be blindsided.\"", callum: "He just told me what he decided. He didn't kill Ashworth — he decided to find Vivienne and tell her first. Either that is the truth or it is the most carefully prepared response in this building tonight.", composure: -15, grants: "northcott_vivienne_motive northcott_decided_interval" },
        pressure: { callum_question: "\"Ashworth had something on you. What was it.\"", response: "He checks the corridor. First time he has done it in a while.\n\n\"Lord Ashworth spoke to many people before the Rite.\" His voice is careful now. \"I don't think it's appropriate for me to characterise private conversations.\" A pause. \"I have given you my record. The record is accurate.\" He looks at the notebook. \"I think I have said everything I can say tonight.\"", callum: "He checked the corridor. He's been doing that all evening and I stopped noticing. He did it just now when I pressed on Ashworth's conversation. The Steward uses that corridor. He is not afraid of me. He is afraid of who might hear.", composure: -22 },
      },
    },

    dialogue: {
      "SNAP1": { snap: true, response: "\"I've been here since seven. I note what I observe. That is what I do here.\" He says it to the room." },
      "SNAP2": { snap: true, response: "\"The record is accurate. I will not add to it under this kind of questioning.\" He straightens." },
      "SNAP3": { snap: true, response: "\"Lord Ashworth told me the record mattered more than the person keeping it. I am beginning to understand why he said that.\" He turns toward the corridor." },
      "FINAL": { final: true, response: "\"I hope you find what you're looking for.\" He means it. He always has." },
    },
    deceptions: {
  ...
  "pemberton-hale": {
    ...
    line_techniques: {
      ...
      ashworth: {
        wait:     { callum_question: "Say nothing. Let Ashworth's name sit between them.", response: "The pause before he answers is the longest of the evening. He looks at the window. Not at you.\n\n\"He found me at seven-oh-five. East corridor.\" A pause. \"He said the committee had already met. He said the clause would not survive the review.\" He looks at the writing case. \"He said by the morning Rite my provisions would revert to their original form.\" Another pause — slower. \"He said it without anger. He said it the way you state a fact that has already been decided.\" He adjusts his cuff. Once. \"He said it at seven-oh-five. The Rite opened at eight. I had fifty-five minutes to decide what that meant.\"\n\nHe stops. He has said more than he intended.", callum: "Fifty-five minutes. He counted them. He said he had to decide what it meant. He has not said what he decided. That decision is still in this room.", composure: 0, grants: "hale_immunity_motive" },
        account:  { callum_question: "\"Walk me through Lord Ashworth's conversation with you tonight.\"", response: "He opens the writing case. He does not take anything out. He just opens it.\n\n\"Seven-oh-five. East corridor.\" He says it precisely. \"Lord Ashworth informed me the Bond Review committee had convened that afternoon. Informally. He said the immunity clause I had added eighteen months ago had been identified as irregular. He said the committee's finding would be read into the Register tonight.\" A pause. \"He said my provisions would revert. He said it was not personal. He said the Bond has provisions and provisions exist to be observed.\" He closes the writing case. \"He said nothing would stop the reading. Those were his words. Nothing would stop it.\"", callum: "He opened the writing case and didn't take anything out. He needed something to do with his hands for that answer. Nothing would stop it — Ashworth's words, repeated precisely. That sentence has been running in his head since seven-oh-five.", composure: -8, grants: "hale_immunity_motive" },
        approach: { callum_question: "\"He told you tonight was the end of it.\"", response: "He looks at you for a moment. The look recalibrates.\n\n\"He told me the clause would not survive review.\" He says it flatly. \"He told me tonight.\" A pause. \"I have been a member of this Estate for some years. My family has been a member for four generations. Lord Ashworth told me at seven-oh-five that by the morning Rite that would no longer be the case.\" He looks at the writing case. \"I imagine you can work out what that meant.\"", callum: "He said I can work out what it meant. He's right. Four generations of membership. The immunity clause he spent eighteen months building failing at the one moment it mattered. Fifty-five minutes between that sentence and the Rite opening. He left me to do the arithmetic.", composure: -12, grants: "hale_immunity_motive" },
        pressure: { callum_question: "\"Ashworth had something on you. What was it.\"", response: "Something in him goes very still.\n\n\"Lord Ashworth conducted his affairs within the standing provisions of the Bond.\" The sentences are short now. Final. \"I have given you the relevant institutional context. The rest is private.\" He looks at you directly. \"I think we are done for this evening.\"", callum: "Private. Everything before it was institutional. The moment I pressed on what Ashworth actually said he drew a line between what belongs to the record and what belongs to him. Whatever is on his side of that line is the thing that matters.", composure: -22 },
      },
    },
